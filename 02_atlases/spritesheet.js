...
SpriteSheetClass = Class.extend({
    ...
    load: function (imgName) {
        ...
        gSpriteSheets[imgName].parseAtlasDefinition(JSON.stringify(packerData));

        this.img.onload = function() {
            for(var i = 0; i < 60; i++) {
                drawSprite(gSpriteSheets[imgName].sprites[i].id, 100, 100 + 100*i);
            }
        }
    },
...
function start() {
    var tempSprite = new SpriteSheetClass();
    tempSprite.load("grits_effects.png");
