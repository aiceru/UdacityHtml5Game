    ...
    draw: function (ctx) {
        ...
        for(var layerIdx = 0; layerIdx < gMap.currMapData.layers.length; layerIdx++) {
            ...
            for(var tileIDX = 0; tileIDX < dat.length; tileIDX++) {
                ...
                //
                // YOUR CODE HERE
                var xToDraw = Math.floor(tileIdx % gMap.numXTiles) * gMap.tileSize.x;
                var yToDraw = Math.floor(tileIdx / gMap.numXTiles) * gMap.tileSize.y;
                ...
                //
                // YOUR CODE HERE
                ctx.drawImage(tPKT.img, tPKT.px, tPKT.py, gMap.tileSize.x, gMap.tileSize.y, xToDraw, yToDraw, gMap.tileSize.x, gMap.tileSize.y);
